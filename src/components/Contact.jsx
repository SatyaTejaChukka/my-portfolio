                ...
                <div className="contact-grid">
                    ...
                    <div>
                        ...
                        <div className="space-y-6">
                            <a href="mailto:satyateja671@gmail.com" className="flex items-center gap-4 hover:text-[var(--primary)] transition-colors group" style={{ marginTop: '5px', marginBottom: '5px', paddingTop: '5px', paddingBottom: '5px' }}>
                                <div className="p-2">
                            ...
                            <a href="tel:+916301304206" className="flex items-center gap-4 hover:text-[var(--primary)] transition-colors group" style={{ marginTop: '5px', marginBottom: '5px', paddingTop: '5px', paddingBottom: '5px' }}>
                                <div className="p-2">
                            ...
                            <a href="https://wa.me/916301304206" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 hover:text-[var(--primary)] transition-colors group" style={{ marginTop: '5px', marginBottom: '5px', paddingTop: '5px', paddingBottom: '5px' }}>
                                <div className="p-2">
